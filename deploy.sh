...
kubectl set image deployments/client-deployment client=ibrahimsobhy/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=ibrahimsobhy/multi-worker:$SHA